  ...
  return <section id="inicio" className="relative min-h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          {/* Main Content */}
          {PROJECT_STATE.hero.showMainContent && <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
              {/* Main Title */}
              ...
              {PROJECT_STATE.hero.showCallToAction && <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center pt-4 sm:pt-6">
                  <a href="https://wa.me/5555981465271" className="btn-accent inline-flex items-center gap-3 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 group w-full sm:w-auto justify-center" target="_blank" rel="noopener noreferrer">
                    <Users className="w-5 h-5 group-hover:scale-110 transition-transform" />
                    Falar com Especialista
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </a>
                  <button onClick={scrollToServicos} className="btn-outline inline-flex items-center gap-3 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 group w-full sm:w-auto justify-center border-white/60 text-white hover:bg-white hover:text-primary">
              ...
              {/* Company Statistics */}
              {PROJECT_STATE.hero.showStatistics && <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 pt-8 sm:pt-12 lg:pt-16">
